...
(function(){
  ...
  function buildVolumePopup(){
    ...
    overlay.innerHTML = `
        ...
        <p style="font-family:'Space Mono', monospace; font-size:0.8rem; color:var(--ink-faint); margin-top:0.8rem; text-align:center;">Double-click the speaker icon to mute or unmute.</p>
      </div>
    `;
